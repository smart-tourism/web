        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-3 pt-4">
            ...
            <div className="col-span-1 text-end">
                <Link href="/auth/forgotpassword" className="text-blue-700 hover:text-blue-700">
                    Lupa Password?
                </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col mt-5 mb-2">
            ...
            <div className="flex mt-3 items-center flex-row justify-center">
              <div className="flex mt-2 items-center flex-row justify-center">
                <p className="text-xl mr-2 text-black">Belum memiliki akun?</p>
                <Link href="/auth/signup" className="text-blue-700 hover:text-blue-700">
                    Daftar
                </Link>
              </div>
            </div>
